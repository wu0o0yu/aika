        ...
        >
{
    ...
    @Override
    public PrimaryInhibitorySynapse instantiateTemplate(PatternNeuron input, InhibitoryNeuron output) {
        PrimaryInhibitorySynapse s = new PrimaryInhibitorySynapse();
