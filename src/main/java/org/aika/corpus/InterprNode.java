...
/**
 * The <code>InterprNode</code> class represents a node within the interpretations lattice. Such a node consists of a conjunction of
 * primitive interpretation nodes that are emitted during each activation of a <code>Neuron</code> (but not the InputNeurons).
