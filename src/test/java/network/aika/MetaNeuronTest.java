...
public class MetaNeuronTest {
    ...
    public void setupMetaNeuronTest(AIKADebugger debugger) {
        ...
        CategoryNeuron letterCat = new CategoryNeuron();


        TokenNeuron letter = new TokenNeuron();
        letter.setLabel("Abstract Letter");
        letter.setTemplate(true);
        letter.getBias().setValue(3.0);

        Synapse.init(new CategoryInputSynapse(), letterCat, letter, 1.0);

        TokenNeuron letterS = letter.instantiateTemplate(true);
...
*/
        ...
        processTokens(letter, doc, List.of("s"));
