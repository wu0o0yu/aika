 ...
 */
public class InhibitoryParticleLink<L extends AbstractInhibitoryLink> extends ParticleLink<L> {

    public InhibitoryParticleLink(L l, Edge e, ActivationGraphManager gm) {
        super(l, e, gm);
    }

    public static ParticleLink create(AbstractInhibitoryLink l, Edge e, ActivationGraphManager gm) {
